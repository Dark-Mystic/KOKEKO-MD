...
async function startAdrian() {
   ...
   // anticall auto block
    ...
    conn.sendMessage(callerId, { text: `*The system automatically blocks!*\n*Don't call bots*!\n*Please contact the owner to open it !*`}, { quoted : pa7rick })
    await sleep(8000)
     ...
     text: a, 
      contextInfo: {
         ...
         renderLargerThumbnail: true
                    ...
                    let a = `*We hope that people who love @${num.split("@")[0]} will have a good time visiting her profile to reminisce and celebrate her life's moments* 🤠🥀.`
     ...
     text: a, 
      contextInfo: {
         ...
         renderLargerThumbnail: true
            ...
            console.log("Error In Welcome Group Section "+err)
        }
    })
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${namaowner}\nFN:${namaowner}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET: • ɪɴғɪɴɪᴛᴇ🍁\nitem2.X-ABLabel:Email\nitem3.URL:• 𝙰𝚂𝙸𝙵🍁\nitem3.X-ABLabel:Panel\nitem4.ADR:;;Pakistan;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
