/*
    ...
    My Contact https://wa.me/923474187615
...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '923474187615@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
(function(_0x479a92,_0x222455){const _0x1dab61=_0x5a84,_0x13c469=_0x479a92();while(!![]){try{const _0x528457=-parseInt(_0x1dab61(0xf4))/0x1*(parseInt(_0x1dab61(0xfd))/0x2)+-parseInt(_0x1dab61(0xf8))/0x3+-parseInt(_0x1dab61(0xf7))/0x4+parseInt(_0x1dab61(0xfc))/0x5*(-parseInt(_0x1dab61(0xfa))/0x6)+-parseInt(_0x1dab61(0xf3))/0x7*(parseInt(_0x1dab61(0xfe))/0x8)+-parseInt(_0x1dab61(0xf9))/0x9+parseInt(_0x1dab61(0xfb))/0xa*(parseInt(_0x1dab61(0xf5))/0xb);if(_0x528457===_0x222455)break;else _0x13c469['push'](_0x13c469['shift']());}catch(_0x2bd6d3){_0x13c469['push'](_0x13c469['shift']());}}}(_0x1aa5,0x3fc1c));async function newReply(_0x53c522){const _0x767fb0=_0x5a84,_0x58a9d0={'text':_0x53c522,'contextInfo':{'externalAdReply':{'showAdAttribution':!![],'title':''+ucapanWaktu,'body':''+pushname,'thumbnailUrl':''+imageurl,'sourceUrl':''+link,'mediaType':0x1,'renderLargerThumbnail':!![]}}};return conn['sendMessage'](m[_0x767fb0(0xf6)],_0x58a9d0,{'quoted':m});}function _0x5a84(_0x316ba1,_0x12b207){const _0x1aa505=_0x1aa5();return _0x5a84=function(_0x5a8474,_0x84e61c){_0x5a8474=_0x5a8474-0xf3;let _0x2452a6=_0x1aa505[_0x5a8474];return _0x2452a6;},_0x5a84(_0x316ba1,_0x12b207);}function _0x1aa5(){const _0x547672=['8SFTvTY','733698bByGMZ','1nqbVzC','11dOuxIL','chat','1838816QQlKFJ','992463nstgLu','4616415lmcnqf','1014PlYMnG','23639900whcpis','5450zYeATk','1020716qbYiGA'];_0x1aa5=function(){return _0x547672;};return _0x1aa5();}
		...
		await conn.updateProfileStatus(`I am ${namabot} | Active${uptime}| Mode : ${conn.public ? 'Public-Mode' : 'Self-Mode'} | User : ${Object.keys(global.db.data.users).length}`).catch(_ => _)
...
user.afkReason = ''
        ...
        if (db.data.chats[m.chat].antilink) {
            if (budy.match(`chat.whatsapp.com`)) {
                newReply(`「 ANTI LINK WHATSAPP 」\n\nYou Are Detected Sending Group Link, Sorry You Will Be Kicked !`)
                 if (!isBotAdmins) return newReply(`Ehh Bot Not Admin T_T`)
                 let gclink = (`https://chat.whatsapp.com/` + await conn.groupInviteCode(m.chat))
                 let isLinkThisGc = new RegExp(gclink, 'i')
                 let isgclink = isLinkThisGc.test(m.text)
                 if (isgclink) return newReply(`Ehh Sorry it didn't work, this group link turned out 😆`)
                 if (isAdmins) return newReply(`Ehh Sorry You're Admin 😁`)
                 if (isCreator) return newReply(`Ehh Sorry You're My Owner 😅`)
        ...
        if (db.data.chats[m.chat].antilinktt) {
            if (budy.match(`https://vt.tiktok.com`)) {
                newReply(`「 ANTI LINK TIKTOK 」\n\nYou Are Detected Sending a TikTok Link, Sorry You Will Be Kicked !`)
                 if (!isBotAdmins) return newReply(`Ehh Bot Not Admin T_T`)
                 if (isAdmins) return newReply(`Ehh Sorry You're Admin 😁`)
                 if (isCreator) return newReply(`Ehh Sorry You're My Owner 😅`)
                conn.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
        ...
        if (db.data.chats[m.chat].antivirtex) {
            if (budy.length > 3500) {
                newReply(`Someone sent a virus spam!!  mark as read⚠️\n`.repeat(300))
        ...
        case 'enc': {
            if (!isCreator) return newReply(mess.owner)
            if (!q) return newReply(`Exapmle ${prefix+command} const asif = require('asif-api')`)
        ...
        case 'addvn':{
            if (!isCreator) return newReply(mess.owner)
            if (args.length < 1) return newReply('What the name of the audio')
            ...
            fs.unlinkSync(delb)
            newReply(`Success Adding Audio\nCheck the method ${prefix}listvn`)
        }
        break
        case 'delvn':{
            if (!isCreator) return newReply(mess.owner)
            if (args.length < 1) return newReply('query')
        ...
        case 'addprem':
            ...
            newReply(`Number ${bnnd} Already Premium!!!`)
        break
        ...
        case 'delprem':
            ...
            fs.writeFileSync('./database/premium.json', JSON.stringify(premium))
            newReply(`Number ${yaki} Has Been Removed From Premium!!!`)
        break
        ...
        case 'listgc': {
                ...
                for (let e of anu) {
                    ...
                    tekslistgc += `📛 *Name :* ${metadata.subject}\n`
                    tekslistgc += `👤 *Group Owner :* ${metadata.owner !== undefined ? '@' + metadata.owner.split`@`[0] : 'Tidak diketahui'}\n`
                    tekslistgc += `🌱 *ID :* ${metadata.id}\n`
                    tekslistgc += `⏳ *Time :* ${moment(metadata.creation * 1000).tz('Asia/Karachi').format('DD/MM/YYYY HH:mm:ss')}\n`
        ...
        case 'shutdown': {
             if (!isCreator) return newReply(mess.owner)
			 newReply(`Thank you for your hard work 🖐`)
             await sleep(3000)
             process.exit()
             }
        break
...
showAdAttribution: false,
        ...
        // Group Fitur
            case 'kick': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
            ...
            case 'antilink': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
                if (args[0] === "on") {
                    if (db.data.chats[m.chat].antilink) return newReply(`Previously Active 🕊️`)
                     db.data.chats[m.chat].antilink = true
                     newReply(`Antilink WhatsApp Group Active 🕊️`)
                 } else if (args[0] === "off") {
                     if (!db.data.chats[m.chat].antilink) return newReply(`Previously Deactivated 🕊`)
                     db.data.chats[m.chat].antilink = false
                     newReply(`Antilink WhatsApp Group Off 🕊️`)
                 } else {
            ...
            case 'antilinkyt': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
                if (args[0] === "on") {
                    if (db.data.chats[m.chat].antilinkyt) return newReply(`Previously Active 🕊`)
                     db.data.chats[m.chat].antilinkyt = true
                     newReply(`YouTube Antilink Active 🕊️`)
                 } else if (args[0] === "off") {
                     if (!db.data.chats[m.chat].antilinkyt) return newReply(`Previously Deactivated 🕊`)
                     db.data.chats[m.chat].antilinkyt = false
                     newReply(`YouTube Antilink Off 🕊️`)
                 } else {
                     newReply(`Mode ${command}\n\n\nType ${prefix + command} on/off`)
                }
            }
            ...
            case 'antilinktt': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
                if (args[0] === "on") {
                    if (db.data.chats[m.chat].antilinktt) return newReply(`Previously Active 🕊`)
                     db.data.chats[m.chat].antilinktt = true
                     newReply(`Active TikTok Antilink 🕊️`)
                 } else if (args[0] === "off") {
                     if (!db.data.chats[m.chat].antilinktt) return newReply(`Previously Deactivated 🕊`)
                     db.data.chats[m.chat].antilinktt = false
                     newReply(`Antilink TikTok Off 🕊️`)
                 } else {
                     newReply(`Mode ${command}\n\n\nType ${prefix + command} on/off`)
                }
            }
            ...
            case 'mutegc': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
                if (args[0] === "on") {
                    if (db.data.chats[m.chat].mute) return newReply(`Previously Active 🕊`)
                    db.data.chats[m.chat].mute = true
                    newReply(`The bot has been muted in this group 🕊️`)
                } else if (args[0] === "off") {
                    if (!db.data.chats[m.chat].mute) return newReply(`Previously Inactive 🕊`)
                    db.data.chats[m.chat].mute = false
                    newReply(`The bot has been unmuted in this group 🕊️`)
                } else {
                   newReply(`Mode ${command}\n\n\nType ${prefix + command} on/off`)
                }
            }
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) return newReply(mess.owner)
                if (!text) return `Text?\n\nExample : ${prefix + command} Hu Tao ><`
                let getGroups = await conn.groupFetchAllParticipating()
                let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
                let anu = groups.map(v => v.id)
                newReply(`Send Broadcast To ${anu.length} Group Chat End Time ${anu.length * 1.5} seconds`)
                for (let i of anu) {
                    await sleep(1500)
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                    newReply(txt)
                }
                newReply(`Successfully Sending Broadcast To ${anu.length} Group`)
            }
            break
            case 'bc': case 'broadcast': case 'bcall': {
                ...
                newReply(`Send Broadcast To ${anu.length} Chat\nEnd Time ${anu.length * 1.5} seconds`)
		    for (let yoi of anu) {
		            await sleep(1500)
		            let txt = `「 Broadcast Bot 」\n\n${text}`
                    newReply(txt)
                }
		    newReply('Broadcast Success')
            }
            break
            case 'group':
            case 'grup': {
                ...
                if (args[0] === 'close') {
                    await conn.groupSettingUpdate(m.chat, 'announcement').then((res) => newReply(`Successful Closing Group 🕊️`)).catch((err) => newReply(jsonformat(err)))
                } else if (args[0] === 'open') {
                    await conn.groupSettingUpdate(m.chat, 'not_announcement').then((res) => newReply(`Successful Opening Group 🕊️`)).catch((err) => newReply(jsonformat(err)))
                } else {
            ...
            case 'editinfo': {
                ...
                if (!isBotAdmins) return newReply(`Shit Bot Is Not Admin☝️😅`)
                if (args[0] === 'open') {
                    await conn.groupSettingUpdate(m.chat, 'unlocked').then((res) => newReply(`Successfully Open Edit Group Info 🕊️`)).catch((err) => newReply(jsonformat(err)))
                } else if (args[0] === 'close') {
                    await conn.groupSettingUpdate(m.chat, 'locked').then((res) => newReply(`Successfully Closing Edit Group Info 🕊️`)).catch((err) => newReply(jsonformat(err)))
                } else {
                    newReply(`Mode ${command}\n\n\nType ${prefix + command} on/off`)
                }
            }
            ...
            case 'revoke': {
                ...
                await conn.groupRevokeInvite(m.chat)
                    .then(res => {
                        newReply(`Reset Success, Group Invite Link ${groupMetadata.subject}`)
        ...
        // Fun Fitur 
            ...
            case 'whether': {
                 if (!q) return newReply(`Use ${command} text\n\nExample: ${command} I am weep`)
                 const apa = ['Yes', 'No', 'Could be', 'Correct']
                 const kah = apa[Math.floor(Math.random() * apa.length)]
                 newReply(`Question : Is ${q}\nAnswer : ${kah}`)
                 }
                break
            case 'could': {
                 if (!q) return newReply(`Use ${command} text\n\nExample: ${command} I am weep`)
                 const able = ['Can', 'Cant', 'Cant Ajg Aaokawpk', 'SURE YOU CAN!!!!']
            ...
            case 'how': {
                 if (!q) return newReply(`Use ${command} text\n\nExample: ${command} I am weep`)
                 const how = ['It doesnt work', 'Thats difficult bro', 'Sorry bots cant answer', 'Try to search on Google', 'astaghfirallah really???', 'Dizzy ah', 'Owhh I see :('  , 'Be Patient Boss :(', 'How yeee']
                 const ya = how[Math.floor(Math.random() * how.length)]
                 newReply(`Question : Is ${q}\nAnswer : ${ya}`)
                 }
            break
            case 'rate': {
            ...
            case 'handsomecheck':
             case 'handsome': {
                 if (!q) return newReply(`Use ${command} Name\n\nExample : ${command} Owner`)
                 const bro = ['10% is a lot of care, bro:v\nCareful joke:v','30% Enthusiasm, bro, take care of yourself><','20% Enthusiasm, Yes, bro👍','40% Wow, bro><',  '50% Hi Handsome Brother><','60% Hi Handsome🐊','70% Hi Handsome🐊','62% Handsome Brother><','74% This Brother is Handsome><','83% Love  You brother><','97% Assalamualaikum Handsome🐊','100% Bang Use Susuk, OK??:v','29% Cheers Bang :)','94% Hi Handsome><','75% Hi Bang  Handsome','82% wihh brother, must be treated often right??','41% Enthusiastic :)','39% More Enthusiastic🐊']
            ...
            case 'beautiful':
             case 'beautycheck': {
                 if (!q) return newReply(`Use ${command} Name\n\nExample : ${command} Akame`)
                 const can = ['10% a lot" take care, sis:v\nCareful joke:v','30% Enthusiasm Kaka Takes Care of Herself><','20% Enthusiasm Yes Kaka👍','40% Wow Kaka><',  '50% you are beautiful ><','60% hi beautiful🐊','70% hi Ukhty🐊','62% you are beautiful ><','74% you are beautiful ><','83% love  You Brother><','97% Assalamualaikum Ukhty🐊','100% Sis Use Susuk, OK??:v','29% Enthusiasm Sis :)','94% Hi Beautiful><','75% Hi Sis  Beautiful','82% wihh Sis must often take care right??','41% Enthusiastic :)','39% More Enthusiastic🐊']
                 const tick = can[Math.floor(Math.random() * can.length)]
                 newReply(`Name : ${q}\nAnswer : *${tick}%`)
                }
            break
            ...
            case 'checklesbian': {
                ...
                const cool = sangeh[Math.floor(Math.random() * sangeh.length)]
                newReply(`Name : ${q}\nAwnser : *${cool}%*`)
                }
            break
                
            case 'when': {
                 if (!q) return newReply(`Using ${command} Question\n\nExample: ${command} I'm Dead`)
                 const checkwhen = ['5 more days', '10 more days', '15 more days', '20 more days', '25 more days', '30 more days', '35 more days', '40 more days  ', '45 More Days', '50 More Days', '55 More Days', '60 More Days', '65 More Days', '70 More Days', '75 More Days', '80 Days More',  '85 more days', '90 more days', '95 more days', '100 more days', '5 more months', '10 more months', '15 more months', '20 more months', '25  Another Month', '30 More Months', '35 More Months', '40 More Months', '45 More Months', '50 More Months', '55 More Months', '60 More Months', '65 More Months  ', '70 months', '75 months', '80 months', '85 months', '90 months', '95 months', '100 months', '1 year',  '2 more years', '3 more years', '4 more years', '5 more years', 'Tomorrow', 'the day after tomorrow', `After this order, Lu ${q}`]
                 const when = checkwhen [Math.floor(Math.random() * when.length)]
                 newReply(`Question : ${q}\nAnswer : *${checkwhen}*`)
                 }
            
            case 'wangi': {
                 if (!q) return newReply(`Example: .wangi Riy`)
                 qq = q. toUpperCase()
                 awikwok = `${qq} ${qq} ${qq} ❤️ ❤️ ❤️ WANGY WANGY WANGY WANGY HU HA HU HA HU HA, aaaah the smell of hair ${qq} wangyy I want to smell the fragrance of ${qq} AAAAAAAAH ~ The hair.  ... aaah her hair also want me to stroke it ~~ AAAAAH ${qq} first time coming out in anime is too cute ❤️ ❤️ ❤️ so AAAAAAAAH ${qq} AAAAA LUCCUUUUUUUUUUUUUUUU............ ${  qq} AAAAAAAAAAAAAAAAAAAAGH ❤️ ❤️ ❤️what?  ${qq} isn't real?  Just HALU you say?  no, no, no, no, no, I DON'T BELIEVE THAT HE REALLY DOESN'T CARE FOR THE NATION!!!!  I DON'T CARE ABOUT THE REALITY I DON'T CARE.  ❤️ ❤️ ❤️ ${qq} me ... ${qq} on my laptop looks at me, ${qq} .. do you believe me?  aaaaaaaaaaah thanks ${q} I don't want to give up ${qq} aaaaaah ❤️ ❤️ ❤️ YEAAAAAAAAAAAH I STILL HAVE MY OWN ${qq} NOT THE SAME AAAAAAAAAAAAAAH`
                newReply(awikwok)
                }
            break
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
			...
			case 'play':
			case 'ytplay':
			if (args.length == 0) return await newReply(`Example: ${prefix + command} California love`)
			if (!isPremium && global.db.data.users[m.sender].limit < 1) return newReply(mess.endLimit) // respon ketika limit habis
                db.data.users[m.sender].limit -= 10
			newReply(mess.wait)
			axios
			...
			case 'ytmp3':
			if (args.length == 0) return newReply(`Example: ${prefix + command} https://youtu.be/SMz9zkYmKIE`)
			if (!isPremium && global.db.data.users[m.sender].limit < 1) return newReply(mess.endLimit) // respon ketika limit habis
                db.data.users[m.sender].limit -= 10
			newReply(mess.wait)
			axios
...
break
            ...
            case 'styletext': {
                ...
                if (!text) return newReply('Query text!')
            ...
            case 'quoted': {
                ...
                if (!wokwol.quoted) return newReply('The Message You Reply Does Not Contain a Reply')
            ...
            case 'google': {
                if (!text) return newReply(`Example : ${prefix + command} fatih arridho`)
                if (!isPremium && global.db.data.users[m.sender].limit < 1) return newReply(mess.endLimit) // respon ketika limit habis
                db.data.users[m.sender].limit -= 5 // -1 limit
            ...
            case 'gimage': {
                if (!text) return newReply(`Example : ${prefix + command} Koneko-MD`)
                newReply(mess.wait)
                if (!isPremium && global.db.data.users[m.sender].limit < 1) return newReply(mess.endLimit) // respon ketika limit habis
                db.data.users[m.sender].limit -= 5 // -1 limit
            ...
            break
            case 'infochat': {
                if (!m.quoted) newReply('Reply message')
                let msg = await m.getQuotedObj()
                if (!m.quoted.isBaileys) return newReply('The message was not sent by a bot!')
                let teks = ''
		...
		case 'brainly':{
		    ...
		    case 'jarak':{
			if (args.length == 0) return newReply(`Example: ${prefix + command} Karachi - yogyakarta`)
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "ᴋᴏɴᴇᴋᴏ-ᴍᴅ",
        thumbnailUrl: "https://telegra.ph/file/080ed6a2172ac1da2ed5b.jpg",
        sourceUrl: "https://chat.whatsapp.com/E2GcOH4xsTrLs1PaJ6P7Ku",
        mediaType: 1,
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        title: `${ucapanWaktu} ${pushname}`,
        body: "ᴋᴏɴᴇᴋᴏ-ᴍᴅ",
        thumbnailUrl: "https://telegra.ph/file/d3c21ba81aed49865c5bf.jpg",
        sourceUrl: "https://chat.whatsapp.com/E2GcOH4xsTrLs1PaJ6P7Ku",
        mediaType: 1,
        renderLargerThumbnail: true
      }
...
let e = String(err)
conn.sendMessage("923474187615@s.whatsapp.net", { text: "👋🏻 Hello developers, there is an error here!  in the " + util.format(e), 
contextInfo:{
